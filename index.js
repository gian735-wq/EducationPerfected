...
(async () => {
    const DIR = {
        email: 'DIC0015@buckleyparkco.vic.edu.au',  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 'Stickman25',  // replace YOUR PASSWORD with your password for auto login
